         ...
         <div className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="font-bold text-foreground">{formatPrice(breakdown.subscriptions)}</p>
                </div>
            </div>
         </div>
         <div className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-xs text-muted-foreground font-medium">Products & PPV</p>
                    <p className="font-bold text-foreground">{formatPrice(breakdown.products)}</p>
                </div>
            </div>
         </div>
         <div className="bg-card p-4 rounded-xl border border-border shadow-sm flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <p className="text-xs text-muted-foreground font-medium">Tips & DMs</p>
                    <p className="font-bold text-foreground">{formatPrice(breakdown.tips + breakdown.dms)}</p>
                </div>
            </div>
         </div>
      </div>
