        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-gray-500 text-lg">Manage your exclusive content and community updates.</p>
            </div>
            <Link
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                     <div className="flex items-center gap-3">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider ${post.isPaid ? 'bg-amber-50 text-amber-600' : 'bg-green-50 text-green-600'}`}>
                     ...
                     <div className="flex gap-2">
                        ...
                        {/* Note: Delete technically needs to be a form or client component for interactivity, 
                            keeping structure simple for server component view 
                        */}
                     </div>
                  </div>
