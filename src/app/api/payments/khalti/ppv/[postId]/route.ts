// Khalti PPV Post Payment Create API
// Creates a Khalti payment for pay-per-view post purchase
...
export async function POST(req: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.log(`[Khalti PPV] Fee calculation for ${post.ppvPrice} ${paymentCurrency}:`, {
    ...
    console.log(`[Khalti PPV] Payment created: ${result.orderId} for post ${post.id}`);
    ...
    console.error("[Khalti PPV] Create payment error:", error);
    return NextResponse.json(
