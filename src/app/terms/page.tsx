      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">3. Creator Responsibilities</h2>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">4. Subscriber Responsibilities</h2>
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">6. Prohibited Content</h2>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground">
                ...
                <a href="mailto:legal@creatorconnect.com" className="text-primary hover:underline">
